  ...
  return (
    <FormWrapper title="your" lastWord="business">
      ...
      <input
        ...
        onChange={(e) => updateFields({ nameOfBusiness: e.target.value })}
      />
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          type="button"
          className={`btn-selectItems py-4 ${product ? "clicked" : ""}`}
          onClick={() => updateFields({ product: true, service: false })}
        >
          <Image
            src={"/product.png"}
            alt="service"
        ...
        <button
          type="button"
          className={`btn-selectItems py-4 ${service ? "clicked" : ""}`}
          onClick={() => updateFields({ product: false, service: true })}
        >
          <Image
            src={"/service.png"}
            alt="service"
